      ...
      <div className="w-full flex justify-start items-start">
        <div className="w-[50px] mt-[12px]">
          <img
            ...
            src="https://img.icons8.com/external-outline-geotatah/64/external-law-election-world-outline-geotatah.png"
            alt="external-law-election-world-outline-geotatah"
          />
        </div>
                  ...
                  <div className="w-[24px]">
                    {item.permission ? (
                      <img
                        ...
                        src="https://img.icons8.com/metro/26/checkmark.png"
                        alt="checkmark"
                      />
                    ) : (
                      <img
