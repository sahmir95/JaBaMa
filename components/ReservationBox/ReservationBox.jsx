...
export const ReservationBox = ({ data }) => {
  ...
  const calculatePrice = () => {
    if (valueExit.dayOfBeginning - valueEnter.dayOfBeginning > 0) {
      let price =
        (data.price.base + calculateExtras() * data.price?.extra) *
        (valueExit.dayOfBeginning - valueEnter.dayOfBeginning);
      return `${price} تومان`;
    } else {
    ...
    <div className="w-full flex justify-center items-center flex-col">
      <div className="w-full flex items-center justify-between">
        <div className="w-[70%] flex justify-start items-center gap-x-[4px]">
          ...
          <div className="  text-[0.65rem] font-light text-main-silver">
            / هرشب
          </div>
        </div>
        <div className="w-[30%] flex justify-end items-center gap-x-[4px]">
          ...
          <div className="text-[0.9rem] font-light">
            ({toFarsiNumber(data.comments)})
          </div>
        </div>
      </div>
      <div className="w-full flex justify-center items-center flex-col mt-[10px]">
        <div className="w-full flex justify-center items-center">
          <div className="w-full flex justify-start items-center px-[20px] py-[10px] border-[1px] border-l-0 border-main-light-gray rounded-tr-[6px]">
          ...
          <div className="w-full flex justify-start items-center px-[20px] py-[10px] border-[1px] border-main-light-gray rounded-tl-[6px]">
        ...
        <div className="w-full flex justify-between items-center rounded-b-[6px] border-[1px] border-t-0 border-main-light-gray px-[20px] py-[12px]">
          <div className="w-full flex justify-start items-start">
            ...
            <div className="w-full">
              <div className="w-full font-medium text-[0.6rem]">
                تعداد مسافران
              </div>
          ...
          <div className="w-full flex justify-end items-center gap-x-[10px]">
            <button
              className="border-[1px] px-[6px] rounded-[8px]"
            ...
            <button
              className="border-[1px] px-[8px] rounded-[8px]"
        ...
        <div className="w-full flex justify-between items-center mt-[12px] ">
          <div className="text-center text-[0.7rem] font-medium text-main-silver">
            1 شب اقامت
          </div>
          <div className="text-center text-[0.7rem] font-medium text-main-silver">
            {" "}
            {/* {toFarsiNumber(data.price.base)} تومان */}
          </div>
        </div>
