                    ...
                    <p className="font-bold text-[0.9rem]">سرویس‌های بهداشتی</p>
                        <div className="flex justify-start items-start font-light text-[0.75rem] lg:gap-x-[4px]">
                            {data.bathroom.persianWC !== 0 ? <p>
                                {data?.bathroom && toFarsiNumber(data.bathroom.persianWC)} سرویس ایرانی .{" "}
                            </p> : <p>سرویس ایرانی وجود ندارد</p>}
                            {data.bathroom.foreignWC !== 0 ? <p>{data?.bathroom && toFarsiNumber(data.bathroom.foreignWC)} سرویس فرنگی . </p> : <p>سرویس فرنگی وجود ندارد.</p>}
                            {data.bathroom.shower !== 0 ? <p>{data?.bathroom && toFarsiNumber(data.bathroom.shower)} حمام</p> : <p>حمام وجود ندارد</p>}
                        </div>
