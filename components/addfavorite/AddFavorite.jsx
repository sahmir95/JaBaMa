...
const AddFavorite = ({ icon, text }) => {
  ...
  return (
    <div className='w-10 h-10 flex lg:text-lg justify-center items-center lg:w-52 lg:h-11 lg:bg-main-white border border-main-light-gray rounded-lg shadow-10xl'>
