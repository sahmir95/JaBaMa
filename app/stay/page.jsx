                            ...
                            <div className="flex justify-center items-center gap-x-[4px]">
                                ...
                                <div className="flex justify-center items-center gap-1">
                                    <img className="w-3 h-3"
                                         ...
                                         alt="marker"/>
                                    <a className="underline font-medium text-main-slate-gray lg:text-[0.85rem]">{data.province},{data.city}</a>
                                </div>
                    ...
                    <div className="w-full lg:w-[68%]">
                        <div className="w-full mt-[20px] flex justify-between items-center">
                            <div className="w-[74%]">
                                ...
                                <div
                                    className="w-full font-medium text-[0.9rem] text-right text-main-black lg:text-[0.85rem]">
                                    اجاره {engToFaType(data.type)} در {data.city} به میزبانی {data.host.name}
                                </div>
                            </div>
                            ...
                            <div className="mt-[20px] flex flex-col justify-around items-center gap-y-[20px]">
                                <div className="w-full flex justify-start items-center gap-x-[10px]">
                                    ...
                                    <div className="w-full">
                                        <p className="font-bold text-[0.9rem]">درباره {engToFaType(data.type)}</p>
                        ...
                        <div className="w-full">
                            <h2 className="mt-[20px] font-bold">توضیحات {engToFaType(data.type)}</h2>
                            <div className="w-full mt-[20px]">
                                <ReadMoreLink text={data.description} type={engToFaType(data.type)}/>
                            </div>
                        </div>
                        <div className="w-full h-[1px] bg-main-light-gray mt-[20px]"></div>
                        <div className="w-full mt-[20px] flex flex-col justify-start items-start gap-y-[20px]">
                            <Facility facility={data.facility} type={engToFaType(data.type)}/>
                        </div>
                        <div className="w-full h-[1px] bg-main-light-gray mt-[20px]"></div>
                        ...
                        <div className="w-full mt-[20px] flex flex-col px-[20px] lg:hidden">
                            ...
                            <div
                                className="w-full h-[200px] flex items-start scroll-smooth scroll-p-[20px] gap-x-[20px] mt-[20px] whitespace-nowrap overflow-x-scroll lg:hidden">
                                <a
                                    href="#"
