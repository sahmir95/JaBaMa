  ...
  return (
    <div className="w-full flex justify-center items-center flex-col">
      <div className="w-full inline relative lg:hidden">
        ...
        <div className="w-full flex justify-center items-center">
          <button className="w-[50px] bg-[#fafafa]">
            <img
              className="w-6 h-6 absolute top-0 z-10"
            ...
            <div className="font-light flex justify-center items-center flex-col mt-5 text-xs gap-1 lg:flex-row lg:gap-[4px]">
              <div className="flex justify-center items-center">
                <div className="flex justify-center items-center gap-x-1 ">
                  ...
                  <a className="underline lg:text-[0.85rem]">
                    (17 نظر ثبت شده)
                  </a>
                </div>
                ...
                <div className="w-full flex justify-start items-center">
                  ...
                  <div className="w-full">
                    ...
                    <p className="font-light text-[0.75rem]">
                      ...
                      {data.capacity.base} نفر پایه + تا {data.capacity.extra}{" "}
                      نفر اضافه)
                    </p>
                  </div>
                </div>
      ...
      <div className="w-full flex justify-start items-start flex-col">
        <p className="font-medium text-[0.9rem]">نفر اضافه</p>
        <p className="font-light text-[0.75rem]">
          هزینه‌ای که برای نفرات بیش از استاندارد (سرویس خواب و ... ) به میلغ
          رزرو اضافه می‌شود.
        </p>
        <p className="font-light text-[0.75rem]">
          قیمت برای هر نفر اضافه به ازای هر شب :
