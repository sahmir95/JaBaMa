  ...
  return (
    <div className="w-full flex justify-center items-center flex-col">
      <div className="w-full inline relative lg:hidden">
        ...
        <div
          className="w-8 h-8 absolute top-2 right-2 z-10 bg-main-white rounded-full flex justify-center items-center"
          onClick={() => router.back()}
        >
          <Icon icon="majesticons:arrow-up" width="22" rotate={1} />
        </div>
      </div>
        ...
        <div className="w-full font-light flex justify-center items-center lg:flex lg:justify-between">
          <div className="lg:flex lg:justify-start lg:items-start lg:flex-col">
            ...
            <div className="font-light flex justify-center items-center flex-col mt-5 text-xs gap-1 lg:flex-row lg:gap-[4px]">
              ...
              <div className="px-[8px] py-[4px] rounded-[16px] bg-main-dark-red mt-[8px] font-medium text-[0.65rem] text-main-white lg:font-bold lg:text-[0.7rem] lg:px-[10px] lg:mt-0">
