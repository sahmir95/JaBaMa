        ...
        <div className="w-full flex justify-center items-center flex-col">
            ...
            <div className="w-full px-[20px] mt-[20px] flex justify-center items-center flex-col">
                ...
                <div className="w-full flex justify-between items-start lg:relative">
                    ...
                    <div
                        className="hidden lg:h-full lg:inline lg:sticky lg:top-0 left-0 lg:w-[26%] lg:p-[20px] lg:border-[1px] lg:border-main-light-gray lg:rounded-[10px] mt-[20px] mb-[40px]">
