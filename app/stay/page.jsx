...
const data = {
    ...
    "facility": [{
        "exist": false,
        name: "سیستم سرمایشی",
        icon: "https://img.icons8.com/sf-ultralight/25/air-conditioner.png",
        alt: "cooling-system"
    },
        {
            "exist": true,
            name: "سیستم گرمایشی",
            icon: "https://img.icons8.com/external-xnimrodx-lineal-xnimrodx/64/external-heater-electronics-xnimrodx-lineal-xnimrodx.png",
            alt: "heating-system"
        },
        {"exist": true, name: "مبلمان", icon: "https://img.icons8.com/ios/50/three-seater-sofa.png", alt: "furniture"},
        {
            "exist": true,
            name: "تلویزیون",
            icon: "https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/external-tv-furniture-royyan-wijaya-detailed-outline-royyan-wijaya.png",
            alt: "TV"
        },
        {
            "exist": false,
            name: "وای فای",
            icon: "https://img.icons8.com/external-outline-berkahicon/64/external-drop-smart-home-outline-berkahicon.png",
            alt: "wifi"
        },
        {
            "exist": true,
        ...
        },
        {
            "exist": true,
            name: "برق",
            icon: "https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/external-electric-plug-bolt-energy-royyan-wijaya-detailed-outline-royyan-wijaya.png",
            alt: "electricity"
        },
        {
            "exist": true,
            name: "گاز",
            icon: "https://img.icons8.com/external-xnimrodx-lineal-xnimrodx/64/external-gas-camping-xnimrodx-lineal-xnimrodx.png",
            alt: "gas"
        }],
        ...
        <div className="w-full flex justify-center items-center flex-col">
            ...
            <div className="w-full px-[20px] mt-[20px] flex justify-center items-center flex-col">
                ...
                <div className="mt-[20px] flex justify-start items-start">
                    <div className="w-[50px] mt-[8px] "><img className="w-[36px] h-[25px]"
                    ...
                    <div className="w-full">
                        ...
                        <p className="w-full font-light text-[0.75rem]">برای رزرو نهایی این آپارتمان نیازی به تأیید از
                            سمت میزبان نخواهید داشت و رزرو شما قطعی خواهد بود.</p>
                    </div>
                </div>
                <div className="w-full h-[1px] bg-main-light-gray mt-[20px]"></div>
                <div className="w-full flex justify-start items-start flex-col mt-[20px]">
                    ...
                    <div className="mt-[20px] flex flex-col justify-around items-center gap-y-[20px]">
                        <div className="w-full flex justify-start items-center">
                            <div className="w-[50px] "><img className="w-[28px] h-[30px]"
                ...
                <div className="w-full flex justify-start items-center flex justify-start items-center flex-col">
                    ...
                    <div className="w-full flex justify-start items-start mt-[20px]">
                        <div className="w-[50px] mt-[8px]">
                            <img className="w-[28px] h-[28px]" src="https://img.icons8.com/ios/50/check-in-desk.png"
                                 alt="extra-person"/>
                        </div>
                ...
                <div className="w-full mt-[20px]">
                    ...
                    <div className="w-full h-[140px] flex justify-between items-center">
                        <div
                            className="w-[48%] h-[100px] flex justify-around items-start flex-col rounded-[10px] border-[1px] border-solid border-main-light-gray shadow-none p-[10px]">
            ...
            <div className="w-full mt-[20px] flex flex-col px-[20px]">
                ...
                <div
                    className="w-full h-[200px] flex items-start scroll-smooth scroll-p-[20px] gap-x-[20px] mt-[20px] whitespace-nowrap overflow-x-scroll">
                    <a href="#"
                       className="w-fit h-fit bg-main-light-grayish-silver font-medium text-[0.9rem] p-[20px] border-[1px] border-main-light-gray rounded-[10px]">اجاره
                        ویلا و سوئیت در کردان </a>
                    <a href="#"
                       className="w-fit h-fit bg-main-light-grayish-silver font-medium text-[0.9rem] p-[20px] border-[1px] border-main-light-gray rounded-[10px]">اجاره
                        ویلا و سوئیت باربیکیودار (منقل) در کردان </a>
                    <a href="#"
                       className="w-fit h-fit bg-main-light-grayish-silver font-medium text-[0.9rem] p-[20px] border-[1px] border-main-light-gray rounded-[10px]">اجاره
